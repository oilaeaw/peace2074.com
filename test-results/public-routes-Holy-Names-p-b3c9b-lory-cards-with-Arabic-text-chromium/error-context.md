...
- Name: public-routes.spec.ts >> Holy Names page >> renders all 99 glory cards with Arabic text
- Location: tests/public-routes.spec.ts:80:5
  ...
  - generic [ref=e4]:
    ...
    - contentinfo [ref=e25]:
      - generic [ref=e26]:
        - generic [ref=e27]:
          - img "decor" [ref=e28]
          - generic [ref=e29]: © 2026 Peace2074 · v3.3.27
        - navigation "Footer links" [ref=e30]:
          - link "About" [ref=e31] [cursor=pointer]:
            - /url: /about
          - link "Quran" [ref=e32] [cursor=pointer]:
            - /url: /quran
          - link "Terms and Conditions" [ref=e33] [cursor=pointer]:
            - /url: /terms
          - link "Privacy Policy" [ref=e34] [cursor=pointer]:
            - /url: /privacy
          - link "Contact" [ref=e35] [cursor=pointer]:
            - /url: /contact
          - link "Credits" [ref=e36] [cursor=pointer]:
            - /url: /credits
...
```ts
  ...
  2   | 
  3   | /**
  4   |  * Public Route E2E Smoke Tests
  5   |  *
  6   |  * Covers every public-facing route that lacks dedicated test coverage.
  7   |  * Each test validates:
  8   |  *   - Page loads without console errors
  9   |  *   - Primary heading (h1) is rendered
  10  |  *   - Key structural content is visible
  11  |  *   - Core navigation links are functional
  12  |  */
  13  | 
  14  | async function dismissCookieBanner(page: Parameters<typeof test>[0]['page']) {
  15  |     await page
  16  |         .getByRole('button', { name: /^accept$/i })
  17  |         .click({ timeout: 3000 })
  18  |         .catch(() => { })
  19  | }
  20  | 
  21  | // ── Home ─────────────────────────────────────────────────────────────────────
