...
- Name: sura-flow.spec.ts >> Quran Navigation and Search Flow >> should apply RTL direction when switching to Arabic locale
- Location: tests/sura-flow.spec.ts:34:5
